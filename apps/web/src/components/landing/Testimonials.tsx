    ...
    <section id="testimonials" className="section-divider py-24">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 text-4xl font-semibold text-slate-950 md:text-5xl">{t.testimonials.title}</h2>
        </div>
        <div className="mt-12 grid md:grid-cols-2 gap-5">
          {t.testimonials.items.map((item, i) => (
            ...
            >
              ...
              <p className="font-display text-lg leading-relaxed text-slate-800">"{item.text}"</p>
